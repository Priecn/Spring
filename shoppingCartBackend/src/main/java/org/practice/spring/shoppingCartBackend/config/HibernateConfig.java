package org.practice.spring.shoppingCartBackend.config;
...
@Configuration
@ComponentScan(basePackages= {"org.practice.spring.shoppingCartBackend"})
...
public class HibernateConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("org.practice.spring.shoppingCartBackend.dto");
